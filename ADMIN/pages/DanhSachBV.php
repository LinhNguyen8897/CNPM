                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                $result="select * from danhmucbaiviet";
                                               $rs_name = $conn->query($result);                                          
                                                while ($row = mysqli_fetch_assoc($rs_name))
                                                {
                                                  ...
                                                  echo"<td>".$row['Luot_xem']."</td>";
                                                  echo"<td>".$row['Ngay_Dang']."</td>";
                                                  echo"<td>".$row['Gio_dang']."</td>";
                                                  echo"<td>".$row['Thu_tu']."</td>";
                                                  echo"<td>".$row['Trang_thai']."</td>";
                                                  
                                                  echo"<td><a href='Edit_Course.php?Ma=$row[Ma]'>Edit</a></td>";
                                                  echo"<th><a href='Delete_BV.php?Ma=$row[Ma] 'onclick='return show_confirm();' sle='color:#f3f;'>Delete</a></th>";    
                                                  echo"</tr>";                                 
                                                }
                                                mysqli_close($conn);  
                                                ?>                                           
